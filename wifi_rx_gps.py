...
# Title: Wifi Rx
# Generated: Thu May  6 08:24:53 2021
##################################################
...
class wifi_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._gain_range = Range(0, 1, 0.01, 0.97, 200)
        ...
        gps_thread = threading.Thread(target=self.write_gps_to_socket, args=(7777,))
        gps_thread.start()
    ...
    def get_gps_location(self):
        return self.uhd_usrp_source_0.get_mboard_sensor("gps_gpgga")

    def write_gps_to_socket(self, port):
        sock = socket.socket()
        ...
        while True:
            gps_str = str(self.get_gps_location())
            conn.sendall(gps_str)
            time.sleep(0.1)
