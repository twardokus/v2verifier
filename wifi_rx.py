...
# Title: Wifi Rx
# Generated: Sun May 31 14:56:22 2020
##################################################
...
class wifi_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._gain_range = Range(0, 1, 0.01, .98, 200)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/administrator/Desktop/out.pcap', False)
