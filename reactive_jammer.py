...
class reactive_jammer(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Reactive Jammer")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Reactive Jammer")
        ...
        self.settings = Qt.QSettings("GNU Radio", "reactive_jammer")
        ...
        self.tx_samp_rate = tx_samp_rate = 10e6
        self.tx_lo_offset = tx_lo_offset = 11e6
        ...
        # Blocks
        ##################################################
        self._tx_samp_rate_options = [1e6,5e6, 10e6, 20e6]
        self._tx_samp_rate_labels = ["1 MHz", "5 MHz", "10 MHz", "20 MHz"]
        self._tx_samp_rate_tool_bar = Qt.QToolBar(self)
        self._tx_samp_rate_tool_bar.addWidget(Qt.QLabel("tx_samp_rate"+": "))
        self._tx_samp_rate_combo_box = Qt.QComboBox()
        self._tx_samp_rate_tool_bar.addWidget(self._tx_samp_rate_combo_box)
        for label in self._tx_samp_rate_labels: self._tx_samp_rate_combo_box.addItem(label)
        self._tx_samp_rate_callback = lambda i: Qt.QMetaObject.invokeMethod(self._tx_samp_rate_combo_box, "setCurrentIndex", Qt.Q_ARG("int", self._tx_samp_rate_options.index(i)))
        self._tx_samp_rate_callback(self.tx_samp_rate)
        self._tx_samp_rate_combo_box.currentIndexChanged.connect(
        	lambda i: self.set_tx_samp_rate(self._tx_samp_rate_options[i]))
        self.top_grid_layout.addWidget(self._tx_samp_rate_tool_bar)
        self._tx_lo_offset_options = (0, 6e6, 11e6, )
        self._tx_lo_offset_labels = (str(self._tx_lo_offset_options[0]), str(self._tx_lo_offset_options[1]), str(self._tx_lo_offset_options[2]), )
        self._tx_lo_offset_tool_bar = Qt.QToolBar(self)
        self._tx_lo_offset_tool_bar.addWidget(Qt.QLabel("tx_lo_offset"+": "))
        self._tx_lo_offset_combo_box = Qt.QComboBox()
        self._tx_lo_offset_tool_bar.addWidget(self._tx_lo_offset_combo_box)
        for label in self._tx_lo_offset_labels: self._tx_lo_offset_combo_box.addItem(label)
        self._tx_lo_offset_callback = lambda i: Qt.QMetaObject.invokeMethod(self._tx_lo_offset_combo_box, "setCurrentIndex", Qt.Q_ARG("int", self._tx_lo_offset_options.index(i)))
        self._tx_lo_offset_callback(self.tx_lo_offset)
        self._tx_lo_offset_combo_box.currentIndexChanged.connect(
        	lambda i: self.set_tx_lo_offset(self._tx_lo_offset_options[i]))
        ...
        self._gain_range = Range(0, 1, 0.01, 0.95, 200)
        ...
        self.uhd_usrp_sink_0.set_center_freq(uhd.tune_request(tx_freq, rf_freq = tx_freq - tx_lo_offset, rf_freq_policy=uhd.tune_request.POLICY_MANUAL), 0)
        ...
        self.ieee802_11_frame_equalizer_0 = ieee802_11.frame_equalizer(chan_est, rx_freq, samp_rate, False, False)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.ieee802_11_decode_mac_0, 'out'), (self.ieee802_11_mac_0, 'app in'))
    ...
    def set_tx_lo_offset(self, tx_lo_offset):
        ...
        self._tx_lo_offset_callback(self.tx_lo_offset)
        self.uhd_usrp_sink_0.set_center_freq(uhd.tune_request(self.tx_freq, rf_freq = self.tx_freq - self.tx_lo_offset, rf_freq_policy=uhd.tune_request.POLICY_MANUAL), 0)
    ...
    def set_rx_freq(self, rx_freq):
        ...
        self.ieee802_11_frame_equalizer_0.set_frequency(self.rx_freq)
...
def main(top_block_cls=reactive_jammer, options=None):
