...
typedef enum SRSLTE_API {
  SRSLTE_SIDELINK_TM1 = 1,
  SRSLTE_SIDELINK_TM2,
  SRSLTE_SIDELINK_TM3,
  SRSLTE_SIDELINK_TM4
} srslte_sl_tm_t;

#define SRSLTE_SIDELINK_TM1 1
#define SRSLTE_SIDELINK_TM2 2
#define SRSLTE_SIDELINK_TM3 3
#define SRSLTE_SIDELINK_TM4 4
...
#define SRSLTE_MAX_NUM_SUB_CHANNEL (20)
...
SRSLTE_API bool srslte_cell_sl_isvalid(srslte_cell_sl_t* cell);
...
SRSLTE_API int srslte_sl_comm_resource_pool_set_cfg(srslte_sl_comm_resource_pool_t* q,
                                                    srslte_cell_sl_t                cell,
